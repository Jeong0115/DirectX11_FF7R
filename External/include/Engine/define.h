...
#define KEY_TAP(Key) KeyMgr::GetInst()->GetKeyState(Key) == KEY_STATE::TAP		
#define KEY_RELEASE(Key) KeyMgr::GetInst()->GetKeyState(Key) == KEY_STATE::RELEASE
#define KEY_PRESSED(Key) KeyMgr::GetInst()->GetKeyState(Key) == KEY_STATE::PRESSED
#define MOUSE_WHEEL() KeyMgr::GetInset()->GetMouseWheel();
